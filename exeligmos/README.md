...
- Saros 141 mode renders only the two glyphs in white; its middle label, directional triangle, and forecast dots are hidden.
...
- Only Spikes with at least five trailing repdigits participate. Both glyphs remain white; the center Saros label and directional triangle are white for 5, blue for 6, purple for 7, yellow for 8, and red for 9 or more.
...
- Runtime performance: Saros 141 bypasses Spike selection, global Spike state is retained across mode switches, and all glyphs share one white core plus seven runtime-rotated arm images. No hidden texture-preload widgets are created.
